...
from core.entities.visas import AppForm, AppFormStatus, Visa
from interfaces.tgbot.views import buttons
from interfaces.tgbot.views.const import DATE_TIME_FORMAT
from interfaces.tgbot.views.users.user import is_admin
from interfaces.tgbot.views.visas.apply_visa import visa_summary
