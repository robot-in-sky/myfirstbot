...
IMAGE_MISMATCH_ERROR_TEXT = ("❌ Не получается распознать изображение\n\n"
                             "Сделайте другое фото и попробуйте снова")

CORNER_DETECTION_ERROR_TEXT = ("❌ Не получается обнаружить углы\n\n"
                               "Убедитесь, что края не обрезаны. "
                               "Используйте по возможности тёмный фон. "
                               "Сделайте другое фото и попробуйте снова")

TEXT_RECOGNITION_ERROR_TEXT = ("❌ Не получается распознать текст\n\n"
