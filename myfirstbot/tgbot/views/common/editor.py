...
from myfirstbot.tgbot.buttons import CANCEL, EDITOR_DOWN, EDITOR_EDIT, EDITOR_UP, PAGE_NEXT, PAGE_PREV, SAVE
...
def editor_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=PAGE_PREV, callback_data="_"),
         InlineKeyboardButton(text=PAGE_NEXT, callback_data="_"),
